...
const FALLBACK_ITEMS: Item[] = [
  ...
  { id: "awards",     label: "Awards",      n: "04" },
  { id: "research",   label: "Research",    n: "05" },
  { id: "work",       label: "Projects",    n: "06" },
  { id: "ecosystem",  label: "Expertise",   n: "07" },
  { id: "credentials",label: "Credentials", n: "08" },
  { id: "linkedin",   label: "LinkedIn",    n: "09" },
  { id: "journal",    label: "Journal",     n: "10" },
  { id: "philosophy", label: "Manifesto",   n: "11" },
  { id: "beyond-me",  label: "Beyond",      n: "12" },
  { id: "contact",    label: "Contact",     n: "13" },
];
