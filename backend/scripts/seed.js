...
async function seed() {
  try {
    ...
    const { error: profileErr } = await supabase.from("profile").upsert({
      ...
      og_image: "https://www.manikantar.in/og-image.jpg",
      welcome_text: "Welcome to my Portfolio.",
      tagline: "Building the future of work through AI, analytics & human insight.",
      resume_url: "https://www.manikantar.in/resume.pdf",
      ...
      ctas: [
        ...
        { label: "Download Resume", href: "https://www.manikantar.in/resume.pdf", type: "ghost", download: true },
      ],
